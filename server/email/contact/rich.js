...
export const rich = data => ({
	data: `<html>
		<head>
			...
			<title>Новое сообщение с сайта Золотая Стрекоза</title>
								...
								<tr>
									<td align="left" valign="top">
										...
										<p style="font-size: 20px; color: #888888;margin-top: 0px">
											Данную информацию оставил один из пользователей сайта Золотая Стрекоза. 
										</p>
										<ul style="margin-top: 20px">
											<li>Имя: ${data.name || "Неизвестно"}</li>
											<li>Телефон: ${data.phone || "Неизвестно"}</li>
											<li>Сообщение: ${data.message || "Без сообщения"}</li>
										</ul>
									</td>
